...
while ~nearGoal
    ...
    elseif strcmp(method, 'lqr')
        [closest_vert, c_vert_index, K] = closestVertexLQR(rrt_verts(:,1:N),xy); % Write this function
    end
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
rrt_parents_grade = rrt_parents(:,1:N);
path = reconstructPath(rrt_verts_grade, rrt_parents_grade, N)
